         ...
         selectedId = id;
          ...
          try {
            ...
            let responsibleDOM = document.querySelector("input[name=responsible]");
             ...
             let progressDOM= document.querySelector("select[name=progress]");
             let Cost_budgetDOM= document.querySelector("select[name=Cost_budget]");
             let financial_budgetDOM= document.querySelector("select[name=financial_budget]");
             let spendingDOM = document.querySelector("select[name=spending]");
 ...
 let messageDOM = document.getElementById('message');
   try {
    let userData = {
      projectnameDOM:document.querySelector("input[name=projectname]").value,
      detailDOM:  document.querySelector("input[name=detail]").value,
      responsibleDOM: document.querySelector("input[name=responsible]").value,
      activityDOM :document.querySelector("input[name=activity]").value,
      startDOM:document.querySelector("input[name=start]").value,
      endDOM  : document.querySelector("input[name=end]").value,
      progressDOM: document.querySelector("select[name=progress]").value,
      Cost_budgetDOM: document.querySelector("select[name=Cost_budget]").value,
      financial_budgetDOM: document.querySelector("select[name=financial_budget]").value,
      spendingDOM : document.querySelector("select[name=spending]").value
     };
